        ...
        <div class="mx-auto">
            <form method="POST" action="" class="items-center">
                ...
                <div class="">
                    ...
                    <input type="text" name="target" id="target" value="{{ isset($url) ? $url->target : '' }}" class="border">
                </div>
                
                
                <div class="flex">
                    <button type="submit" class="bg-blue-500 rounded-xl p-3 border border-blue-500 text-white ml-8 mt-3">Shorten it!</button>
